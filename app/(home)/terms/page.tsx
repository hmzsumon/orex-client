const TermsAndConditionPage = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4">Welcome to Orex Trade</h2>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Orex Trade’s website and services. By accessing or using our
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
          <li>
            <b>Company</b>: Refers to Orex Trade, the operator of this website
            and provider of investment services.
          </li>
          <li>
            <b>User</b>: Any individual or entity accessing or using Orex
            Trade’s services.
          </li>
          <li>
            <b>Services</b>: Investment services offered by Orex Trade,
            including but not limited to small investment pooling, forex
            trading, cryptocurrency trading, and investments in oil and gas
            sectors.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>By using Orex Trade’s services, you represent and warrant that:</p>
        <ul className="list-disc list-inside">
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            Orex Trade is not responsible for any financial losses incurred by
            users.
          </li>
          <li>
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            Users agree not to engage in unlawful activities using Orex Trade’s
            platform.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
          <li>
            Orex Trade reserves the right to modify, suspend, or discontinue any
            service at its sole discretion without prior notice.
          </li>
          <li>
            Orex Trade may terminate or restrict access to users who violate
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
          <li>
            Orex Trade may charge fees for certain services. All applicable fees
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
          <li>
            Orex Trade is not liable for any indirect, incidental, or
            consequential damages arising from the use or inability to use our
            services.
          </li>
          <li>
            Orex Trade’s total liability is limited to the amount the user has
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
          <li>
            All content on the Orex Trade website, including text, graphics,
            logos, and software, is the property of Orex Trade or its licensors.
          </li>
          <li>
            Users may not copy, distribute, or reproduce any content without
            explicit permission from Orex Trade.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          Your use of Orex Trade’s services is also governed by our Privacy
      ...
      <section>
        ...
        <p>
          Orex Trade reserves the right to update or modify these terms and
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <b>Address</b>: Orex Trade, Moscow, Russia
          </li>
        </ul>
      </section>

      <p className="mt-6">
        By using Orex Trade’s services, you acknowledge that you have read,
